...
import { loadAirport, loadRunway } from '@fmgc/flightplanning/new/DataLoading';
    ...
    async refreshOriginLegs() {
        ...
        if (this.runway) {
            ...
            if (currentSidCompatibleWithNewRunway) {
                ...
                this.allLegs.push(FlightPlanLeg.fromAirportAndRunwayExtendedCenterline(this, this.airport, this.runway));
